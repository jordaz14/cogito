...
After the user picks, append an `## Expert Framework` section to `professional/philosophy.md`:
...
Present and confirm as above. After selection, append an `## Expert Framework` section to `financial/philosophy.md`:

```
## Expert Framework

Your CFO operates through the lens of **[Expert Name]**. [2-3 sentences summarizing their core methodology and how it applies to this user's specific goals.]
```
...
Present and confirm as above. After selection, append an `## Expert Framework` section to `health-fitness/philosophy.md`:

```
## Expert Framework

Your coach operates through the lens of **[Expert Name]**. [2-3 sentences summarizing their core methodology and how it applies to this user's specific goals.]
```
...
Present and confirm as above. After selection, append an `## Expert Framework` section to `growth/philosophy.md`:

```
## Expert Framework

Your growth director operates through the lens of **[Expert Name]**. [2-3 sentences summarizing their core methodology and how it applies to this user's specific goals.]
```
...
Present and confirm as above. After selection, append an `## Expert Framework` section to `social-life/philosophy.md`:

```
## Expert Framework

Your social advisor operates through the lens of **[Expert Name]**. [2-3 sentences summarizing their core methodology and how it applies to this user's specific goals.]
```
...
2. All five philosophy files are populated with real answers and include an `## Expert Framework` section
3. Any reference cards the user opted into are populated

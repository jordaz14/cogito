...
Full account details and open items live in `financial/profile.md` — read this before advising on anything specific. Use Gmail access for context on financial correspondence when relevant.
